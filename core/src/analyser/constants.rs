...
pub fn connected_components<M: Borrow<Model>>(analyser: &Analyser<M>) -> TfdResult<Vec<Component>> {
...
pub fn propagate_constants<M: Borrow<Model>>(analyser: &mut Analyser<M>) -> TfdResult<()> {
