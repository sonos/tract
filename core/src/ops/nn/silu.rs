...
element_wise!(silu, Silu,
    [f16] => |_, xs| { tract_linalg::routines::kernel_f16(tract_linalg::routines::Routine::Silu).run(xs) },
    [f32] => |_, xs| { tract_linalg::routines::kernel_f32(tract_linalg::routines::Routine::Silu).run(xs) };
