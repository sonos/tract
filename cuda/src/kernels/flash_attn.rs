...
impl CudaFlashAttn {
    ...
    pub fn dispatch_eval(
        ...
        // Hopper SM90 only, and only when the padded row is 128 B so TMA
        // SWIZZLE_128B matches the software swizzle the MMA already uses.
        let sm_major = ctxt.properties().major;
        let use_tma = sm_major == 9 && padded_d == 64 && d == 64;
