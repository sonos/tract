...
impl EvalOp for CudaConcat {
    ...
    fn eval_with_session(
        ...
        crate::with_cuda_stream(|stream| self.kernel.dispatch_eval(stream, &inputs, &output))?;
        Ok(tvec!(output.into_tensor().into_tvalue()))
    }
}

impl TypedOp for CudaConcat {
    as_op!();
