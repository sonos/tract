...
/// Backend-generic: gated on which backends' device kernels actually
/// implement the fused residual path, not on anything Metal/Cuda-specific
/// in this rule itself.
