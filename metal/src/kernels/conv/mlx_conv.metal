// Implicit-GEMM 2D convolution, ported from Apple MLX
...
// steel/conv/kernels/steel_conv_general.metal (each section verbatim,
// `#pragma once` and intra-repo includes stripped), minus the bf16
// instantiation, since tract has no bf16 datum type. Resync against upstream
// by re-flattening; do not hand-edit the sections.
//
// clang-format off
