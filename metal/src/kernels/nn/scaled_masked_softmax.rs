...
mod tests {
    ...
    fn test_scaled_masked_softmax_f32() -> TractResult<()> {
        with_borrowed_metal_stream(|stream| {
            ...
            let cpu = scaled_masked_softmax::ScaledMaskedSoftmax { scale: scale.clone(), post_softmax_mask: false };
        ...
        f32: AsPrimitive<F>,
    {
        pub fn reference(&self) -> TractResult<Tensor> {
            ...
            let cpu_output = scaled_masked_softmax::ScaledMaskedSoftmax { scale, post_softmax_mask: false }
