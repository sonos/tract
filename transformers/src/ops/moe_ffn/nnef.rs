...
//! Granite MoE (downstream model inference), and synthetic round trips for
//! OLMoE-style full-softmax routing and GPT-OSS-style biased, clamped-SwiGLU
//! blocks. This validates routed FFN interchange, not complete model-family
//! support or all export variants.
