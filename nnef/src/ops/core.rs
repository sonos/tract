...
pub fn register(registry: &mut Registry) {
    ...
    registry.register_element_wise("tract_core_cosh", &tract_core::ops::math::Cosh {});
    registry.register_element_wise("tract_core_sinh", &tract_core::ops::math::Sinh {});
    ...
    registry.register_element_wise("tract_core_round_even", &tract_core::ops::math::RoundHalfToEven {});
}
