...
fn benches(c: &mut Criterion) {
    #[cfg(tract_amx_int8)]
    {
            ...
            &[(64usize, 256usize, 64usize), (256, 256, 256), (512, 512, 512), (1024, 1024, 64)]
        {
            ...
            g.bench_with_input(
                BenchmarkId::new("avx512amx_8x8", &id),
                &(m, k, n),
                |b, &(m, k, n)| run_kernel(b, &*avx512amx_mmm_i32_8x8.mmm(), m, k, n),
            );
            g.bench_with_input(
                BenchmarkId::new("avx512amx_16x16", &id),
                &(m, k, n),
                |b, &(m, k, n)| run_kernel(b, &*avx512amx_mmm_i32_16x16.mmm(), m, k, n),
            );
            g.finish();
        }
    }
