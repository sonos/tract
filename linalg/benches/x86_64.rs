...
unsafe fn packed_packed_2x5(f: Option<&str>) {
    println!("-- 2x5 kernels");
    kloop!(f, "2x5x1", (16 * 6), "2x5/packed_packed_loop1/original.tmpli", 8);
    kloop!(f, "2x5x2", (16 * 6 * 2), "2x5/packed_packed_loop1/original-unroll.tmpli", 8);
...
unsafe fn packed_packed_8x1(f: Option<&str>) {
    ...
    //    kloop!(f, "8x1x1", (64 * 1), "8x1/packed_packed_loop1/avx-512.tmpli", 16);
...
fn main() {
    ...
    unsafe {
        ...
        // packed_packed_1x12(filter.as_deref());
        // packed_packed_32x3(filter.as_deref());
        // packed_packed_40x2(filter.as_deref());
