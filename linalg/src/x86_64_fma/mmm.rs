...
test_mmm_kernel_f32!(MatMatMulF32x8x8, is_x86_feature_detected!("fma"));

test_mmm_kernel_f32!(MatMatMulF32x16x6, is_x86_feature_detected!("fma"));

test_mmm_kernel_f32!(MatMatMulF32x64x1, is_x86_feature_detected!("fma"));

test_mmm_kernel_i32!(MatMatMulI32x8x8, is_x86_feature_detected!("avx2"));
