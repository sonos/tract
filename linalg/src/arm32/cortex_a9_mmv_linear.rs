...
pub fn linear_model() -> LinearCostModel<'static> {
    LinearCostModel {
        ...
        coeffs: &[
            [2.7568363e-9, 3.36097e-7, 1.9963595e-7, 0e0],
            [2.3473936e-9, 6.8262224e-8, 0e0, 0e0],
            [3.715417e-9, 0e0, 0e0, 0e0],
            [4.0768318e-9, 1.5258387e-7, 0e0, 0e0],
            [1.209754e-9, 6.241918e-7, 1.5367328e-6, 0e0],
            [8.698204e-10, 6.1211716e-7, 1.3312181e-6, 0e0],
            [1.3068701e-9, 4.245877e-7, 0e0, 0e0],
            [1.0398751e-9, 5.43976e-7, 1.4077355e-6, 0e0],
            [7.7258056e-10, 5.428761e-7, 1.3314509e-6, 0e0],
            [1.0347576e-9, 4.2044732e-7, 1.9907782e-8, 0e0],
        ],
        restream: 0e0,
    }
}
