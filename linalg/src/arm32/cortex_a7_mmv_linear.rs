...
pub fn linear_model() -> LinearCostModel<'static> {
    LinearCostModel {
        ...
        coeffs: &[
            [1.5368065e-9, 3.004327e-7, 1.2703205e-6, 0e0],
            [1.6503982e-9, 3.120771e-7, 1.2908918e-6, 0e0],
            [1.7416373e-9, 3.0267273e-7, 1.0059667e-6, 0e0],
            [2.0166966e-9, 2.8888527e-7, 1.0519947e-6, 0e0],
            [1.0829506e-9, 5.5748535e-7, 1.6015783e-6, 0e0],
            [1.1075889e-9, 5.601286e-7, 1.5072782e-6, 0e0],
            [1.0996574e-9, 5.4615407e-7, 1.2843658e-6, 0e0],
            [9.972734e-10, 5.486439e-7, 1.5976844e-6, 0e0],
            [1.0140543e-9, 5.4476084e-7, 1.6143154e-6, 0e0],
            [1.012184e-9, 5.3697676e-7, 1.3612033e-6, 0e0],
        ],
        restream: 0e0,
    }
}
