...
pub fn linear_model() -> LinearCostModel<'static> {
    LinearCostModel {
        ...
        coeffs: &[
            [3.5185248e-9, 0e0, 0e0, 0e0],
            [3.212245e-9, 0e0, 0e0, 0e0],
            [4.553206e-9, 0e0, 0e0, 0e0],
            [4.255692e-9, 2.7069701e-8, 0e0, 0e0],
            [1.228173e-9, 5.361867e-7, 0e0, 0e0],
            [9.158042e-10, 4.911403e-7, 0e0, 0e0],
            [1.5475748e-9, 0e0, 0e0, 0e0],
            [1.0450972e-9, 6.4495083e-7, 0e0, 0e0],
            [7.941577e-10, 6.231035e-7, 0e0, 0e0],
            [1.4287171e-9, 0e0, 0e0, 0e0],
        ],
        restream: 0e0,
    }
}
