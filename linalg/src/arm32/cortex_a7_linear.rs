...
pub fn linear_model() -> LinearCostModel<'static> {
    LinearCostModel {
        ...
        coeffs: &[
            [2.358771e-9, 0e0, 0e0, 0e0],
            [2.4038398e-9, 0e0, 0e0, 0e0],
            [2.63956e-9, 0e0, 0e0, 0e0],
            [2.7103022e-9, 1.6456787e-7, 0e0, 0e0],
            [1.3589725e-9, 2.7785512e-7, 0e0, 0e0],
            [1.4101642e-9, 2.3441332e-7, 0e0, 0e0],
            [2.5812041e-9, 0e0, 0e0, 0e0],
            [1.2186382e-9, 3.1301494e-7, 0e0, 0e0],
            [1.2247628e-9, 3.283357e-7, 0e0, 0e0],
            [2.1503057e-9, 0e0, 0e0, 0e0],
        ],
        restream: 0e0,
    }
}
