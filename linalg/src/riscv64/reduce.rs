...
macro_rules! rvv_reduce {
    ($func: ident, $neutral: expr, $red: expr, $reduce_two: item) => {
        reduce_impl_wrap!(
            f32,
            $func,
            4,
...
mod test {
    ...
    mod max {
        use super::*;
        crate::max_frame_tests!(has_rvv(), f32, rvv_max_f32);
    }
    mod min {
        use super::*;
        crate::min_frame_tests!(has_rvv(), f32, rvv_min_f32);
    }
    mod sum {
        use super::*;
        crate::sum_frame_tests!(has_rvv(), f32, rvv_sum_f32);
    }
}
