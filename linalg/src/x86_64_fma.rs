...
pub fn plug(ops: &mut Ops) {
    if is_x86_feature_detected!("fma") {
        ops.mmm_f32 = Box::new(|m, k, n| {
            Box::new(MatMatMulImpl::<mmm::MatMatMulF32x16x6, f32>::new())
        });
        ops.mmv_f32 =
            Box::new(|m, k| Box::new(MatMatMulImpl::<mmm::MatMatMulF32x64x1, f32>::new()));
    ...
    if is_x86_feature_detected!("avx2") {
        ops.qmmm_i8_i8 =
            Box::new(|m, k, n| Box::new(MatMatMulImpl::<mmm::MatMatMulI8x8x8, i32>::new()));
        ops.qmmm_i8_i32 = Box::new(|m, k, n| {
            Box::new(MatMatMulImpl::<mmm::MatMatMulI8xI32x8x8, i32>::new())
        });
