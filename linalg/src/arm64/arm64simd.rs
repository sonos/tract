...
MMMExternKernel2!(aarch64; arm64simd_mmm_f32_8x8_a55 <f32>(8,  8)@(16, 16) quality(ManuallyOptimized) boost(a55));
MMMExternKernel2!(aarch64; arm64simd_mmm_f32_12x8_a55<f32>(12, 8)@(16, 16) quality(ManuallyOptimized) boost(a55));
MMMExternKernel2!(aarch64; arm64simd_mmm_f32_16x4_a55<f32>(16, 4)@(16, 16) quality(ManuallyOptimized) boost(a55));
MMMExternKernel2!(aarch64; arm64simd_mmm_f32_24x4_a55<f32>(24, 4)@(16, 16) quality(ManuallyOptimized) boost(a55));
MMMExternKernel2!(aarch64; arm64simd_mmm_f32_64x1_a55<f32>(64, 1)@(16, 16) quality(ManuallyOptimized) boost(a55));

MMMExternKernel2!(aarch64; arm64simd_mmm_f32_16x4_a53<f32>(16, 4)@(16, 16) quality(ManuallyOptimized) boost(a53));
MMMExternKernel2!(aarch64; arm64simd_mmm_f32_24x4_a53<f32>(24, 4)@(16, 16) quality(ManuallyOptimized) boost(a53));
MMMExternKernel2!(aarch64; arm64simd_mmm_f32_8x8_a53 <f32>(8,  8)@(16, 16) quality(ManuallyOptimized) boost(a53));
MMMExternKernel2!(aarch64; arm64simd_mmm_f32_12x8_a53<f32>(12, 8)@(16, 16) quality(ManuallyOptimized) boost(a53));
MMMExternKernel2!(aarch64; arm64simd_mmm_f32_64x1_a53<f32>(64, 1)@(16, 16) quality(ManuallyOptimized) boost(a53));

MMMExternKernel2!(aarch64; arm64simd_mmm_f32_16x4_gen<f32>(16, 4)@(16, 16) quality(ManuallyOptimized));
MMMExternKernel2!(aarch64; arm64simd_mmm_f32_24x4_gen<f32>(24, 4)@(16, 16) quality(ManuallyOptimized));
MMMExternKernel2!(aarch64; arm64simd_mmm_f32_8x8_gen <f32>(8,  8)@(16, 16) quality(ManuallyOptimized));
MMMExternKernel2!(aarch64; arm64simd_mmm_f32_12x8_gen<f32>(12, 8)@(16, 16) quality(ManuallyOptimized));
MMMExternKernel2!(aarch64; arm64simd_mmm_f32_64x1_gen<f32>(64, 1)@(16, 16) quality(ManuallyOptimized));

fn q40p32z16se() -> PackedBlockQuantFormat {
    PackedBlockQuantFormat::new(&Q4_0, 32, 16, true)
}

MMMExternKernel2!(aarch64; arm64simd_mmm_f32_32x1_gen<f32>(32, 1)@(16, 16)
...
MMMExternKernel2!(aarch64; arm64simd_mmm_f32_32x3_gen<f32>(32, 3)@(16, 16)
...
MMMExternKernel2!(aarch64; arm64simd_mmm_i32_8x8<i32>(8, 8)@(16, 16)
...
MMMExternKernel2!(aarch64; arm64simd_mmm_i32_8x8_dot<i32>(8, 8)@(16, 16)
...
MMMExternKernel2!(aarch64; arm64simd_mmm_i32_64x1<i32>(64, 1)@(16, 1)
...
tanh_impl!(arch aarch64; f32, arm64simd_tanh_f32_4n, 4, 4, cfg!(target_arch = "aarch64"));
sigmoid_impl!(arch aarch64; f32, arm64simd_sigmoid_f32_4n, 4, 4, cfg!(target_arch = "aarch64"));
