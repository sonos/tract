...
pub fn suite() -> TractResult<TestSuite> {
    ...
    suite.add(
        ...
        QConvProblem {
            ...
            kernel_format: OIHW,
            group: 1,
            data: Tensor::zero::<i8>(tvec![2, 1, 1]).unwrap(),
            kernel: tensor3(&[[[1i8]]]),
            bias: None,
            qp,
            raw_output_dt: DatumType::I8,
    ...
    suite.add(
        ...
        QConvProblem {
            ...
            kernel_format: OIHW,
            group: 1,
            data: Tensor::zero::<i8>(tvec![1, 1, 1, 1]).unwrap(),
            kernel: Tensor::zero::<i8>(tvec![2, 1, 1, 1]).unwrap(),
            bias: Some(arr1(&[1, 2])),
            qp: qp_noop_i8(),
            raw_output_dt: DatumType::I8,
        },
    ...
    suite.add(
        ...
        QConvProblem {
            ...
            kernel_format: OIHW,
            group: 1,
            data: Tensor::zero::<i8>(tvec![1, 1]).unwrap(),
            kernel: Tensor::zero::<i8>(tvec![2, 1, 1]).unwrap(),
            bias: Some(arr1(&[0, 1])),
            qp,
            raw_output_dt: DatumType::I8,
        },
    ...
    let mut qp = qp_noop_i8();
    qp[0] = tensor0(-1i32);
    let mut kernel = Tensor::zero::<i8>(tvec![5, 1, 2]).unwrap();
    *kernel.as_slice_mut::<i8>().unwrap().last_mut().unwrap() = -1;
    suite.add(
        ...
        QConvProblem {
            ...
            kernel_format: OIHW,
            group: 1,
            data: Tensor::zero::<i8>(tvec![2, 1]).unwrap(),
            kernel,
    ...
    suite.add(
        ...
        QConvProblem {
            ...
            group: 1,
            data: Tensor::zero::<i8>(tvec![1, 1, 1, 1]).unwrap(),
            kernel: Tensor::zero::<i8>(tvec![1, 1, 1, 1]).unwrap(),
            bias: Some(arr1(&[1])),
            qp: qp_noop_i8(),
            raw_output_dt: DatumType::I8,
        },
    ...
    suite.add(
        ...
        QConvProblem {
            ...
            kernel_format: OIHW,
            group: 1,
            data: Tensor::zero::<i8>(tvec![1, 1, 1]).unwrap(),
            kernel: Tensor::zero::<i8>(tvec![1, 1, 1]).unwrap(),
            bias: Some(arr1(&[1])),
            qp,
            raw_output_dt: DatumType::I8,
        },
    ...
    suite.add(
        ...
        QConvProblem {
            ...
            kernel_format: OIHW,
            group: 1,
            data: Tensor::zero::<i8>(tvec![1, 2]).unwrap(),
            kernel: Tensor::zero::<i8>(tvec![5, 2, 1]).unwrap(),
            bias: None,
            qp,
            raw_output_dt: DatumType::I8,
        },
    ...
    suite.add(
        ...
        QConvProblem {
            ...
            kernel_format: OIHW,
            group: 1,
            data: Tensor::zero::<i8>(tvec![1, 1, 2]).unwrap(),
            kernel: Tensor::zero::<i8>(tvec![2, 1, 1, 2]).unwrap(),
            bias: None,
            qp,
            raw_output_dt: DatumType::I8,
        },
    ...
    suite.add(
        ...
        QConvProblem {
            ...
            group: 1,
            data: Tensor::zero::<i8>(tvec![1, 1, 2]).unwrap(),
            kernel: Tensor::zero::<i8>(tvec![2, 1, 2]).unwrap(),
            bias: None,
            qp,
            raw_output_dt: DatumType::I8,
        },
    ...
    suite.add(
        ...
        QConvProblem {
            ...
            kernel_format: OIHW,
            group: 1,
            data: Tensor::zero::<u8>(tvec![1, 1]).unwrap(),
            kernel: Tensor::zero::<i8>(tvec![1, 1, 1]).unwrap(),
            bias: None,
            qp,
