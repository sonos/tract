...
net_bench en_tdnn_15M 2600ms $CACHEDIR/en_tddn_15M.onnx --output-node output -i 264x40
net_bench en_tdnn_15M pulse_240ms $CACHEDIR/en_tddn_15M.onnx --output-node output -i Sx40 --pulse 24
